...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&sql_model.User{})
...
type user struct {
	...
	Mobile        field.String
	Email         field.String
	UserType      field.Int32  // 1:C 2: 3: 4:
...
func (u userDo) Create(values ...*sql_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*sql_model.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*sql_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*sql_model.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*sql_model.User), nil
	}
}

func (u userDo) Take() (*sql_model.User, error) {
...
func (u userDo) Last() (*sql_model.User, error) {
...
func (u userDo) Find() ([]*sql_model.User, error) {
	result, err := u.DO.Find()
	return result.([]*sql_model.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sql_model.User, err error) {
	buf := make([]*sql_model.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*sql_model.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*sql_model.User, error) {
...
func (u userDo) FirstOrCreate() (*sql_model.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*sql_model.User, count int64, err error) {
...
func (u userDo) Delete(models ...*sql_model.User) (result gen.ResultInfo, err error) {
